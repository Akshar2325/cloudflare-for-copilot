...
import type { OpenAIFunctionTool, OpenAIMessage, OpenAIToolCall } from "./types";
...
export function convertTools(options: vscode.LanguageModelChatRequestHandleOptions): {
	...
	const toolDefs: OpenAIFunctionTool[] = tools
 ...
 */
function mapRole(message: vscode.LanguageModelChatRequestMessage): Exclude<OpenAIMessage["role"], "tool"> {
